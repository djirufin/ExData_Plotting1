...
#Global Active Power
plot(as.numeric(as.character(df$Global_active_power)), type = "l", ylab = "Global Actif Power")

#Voltage
plot(as.numeric(as.character(df$Voltage)), type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(as.numeric(as.character(df$Global_reactive_power)), type = "l", ylab = "Global_reactive_power", xlab = "datetime")
